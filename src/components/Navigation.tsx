...
export default function Navigation({
	...
	return (
		<nav className={cn(className, 'lg:flex lg:flex-col lg:gap-6')}>
								...
								<span
									className={cn(
										activeCategory === category
											? 'text-primary-700 dark:text-primary-400 translate-x-2'
											: 'transform hover:translate-x-2 dark:text-zinc-400 text-zinc-500',
										'text-sm  hover:text-primary-700 capitalize dark:hover:text-primary-400 transition-all w-full block '
									)}
								>
									{category}
								</span>
								...
								<li className=''>
									<Link
										...
										className={cn(
											...
											activeSubCategory === _sub && activeCategory === category ? ' bg-zinc-100 dark:bg-zinc-700' : ''
										)}
									>
										<span
											className={cn(
